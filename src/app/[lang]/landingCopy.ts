...
const en: LandingCopy = {
  marquee: [
    ...
    "bold one day. clean the next.",
    "two sides. one bag.",
    "made in tbilisi",
  ],
  nav: { shop: "Shop", story: "Our story", process: "How it's made", journal: "Journal" },
  hero: {
    eyebrow: "New drop · spring '26",
    titlePart1: "Two sides.",
    titleItalic: "One",
    titlePart2: "bag.",
    titleSquiggle: "Zero compromises",
    lead: "Not a print on a bag. Two completely different bags in one. Pick your mood. Flip when it changes. Made by hand in Tbilisi.",
    ctaPrimary: "Shop the drop",
    ctaSecondary: "See both sides",
    socialProof: "2,400+ happy customers · verified reviews",
  ...
  story: {
    ...
    titleItalic: "two",
    titlePart2: "lives.",
    body: "Tissu started with one idea: both sides of a bag should actually be good. Canvas, a sewing machine, no shortcuts. Flip it — two designs, one piece. Still small, still handmade in Tbilisi, still obsessed with getting every detail right.",
    stats: [
  ...
  footer: {
    tagline: "Two sides. One bag. Made by hand in Tbilisi since 2023.",
...
const ka: LandingCopy = {
  ...
  hero: {
    ...
    titlePart1: "ორი მხარე.",
    titleItalic: "ერთი",
    titlePart2: "ჩანთა.",
    titleSquiggle: "კომპრომისის გარეშე",
    lead: "არა ბეჭდი ჩანთაზე. ორი სრულიად განსხვავებული ჩანთა — ერთში. აირჩიე განწყობა. გადმოაბრუნე, როცა შეიცვლება. ხელით ნაკერი თბილისში.",

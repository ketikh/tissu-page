...
const C = {
  ...
  champagne:   "#c9a86c",
  rose:        "#c4849a",
  hotPink:     "#e03d7a",  // vibrant magenta — matches reference title
  teal:        "#1e4d43",
  blue:        "#5a9fd4",
  blueDark:    "#3a7faa",
  lavender:    "#9e8abf",
...
/* ─── 4-petal clover via circle-arc petals (SSR-safe, no Math.random) ─── */
...
// 4-petal clover: plump round petals with deep waists — matches reference shape
const FLOWER = flowerPath(4, 65, 110, 250, 250);
  ...
  return (
    <div style={{ background: C.cream, minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      <div aria-hidden="true" style={{
        ...
        borderRadius: "50%",
        background: "radial-gradient(circle, rgba(224,61,122,0.07) 0%, transparent 65%)",
        pointerEvents: "none",
      }} />
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12 pt-7 md:pt-11 pb-0 relative z-10">
        ...
        {/* ── Breadcrumb ── */}
        <nav className="flex items-center gap-1.5 mb-5 md:mb-8 overflow-x-auto whitespace-nowrap"
        ...
        <div style={{
          border: `2px dashed rgba(224,61,122,0.4)`,
          borderRadius: 40,
          ...
          {/* ── Product grid ── */}
          <div className="grid gap-6 lg:gap-10 xl:gap-14 lg:grid-cols-[1.2fr_0.8fr] items-start">
            ...
            >
              ...
              <span aria-hidden="true" style={{
                position: "absolute", top: "6%", left: "2%", zIndex: 8,
                fontSize: 22, color: C.mustard, transform: "rotate(-10deg)",
                lineHeight: 1, pointerEvents: "none",
              }}>✦</span>
              <span aria-hidden="true" style={{
                position: "absolute", bottom: "10%", right: "1%", zIndex: 8,
                fontSize: 14, color: C.lavender,
                lineHeight: 1, pointerEvents: "none",
              }}>✦</span>

              {/* Rotated sticker — brand element */}
              <div style={{
                position: "absolute", top: "3%", left: "-1%", zIndex: 15,
              ...
              {/* ── 4-petal clover photo — large, fills column ── */}
                ...
                >
                  <defs>
                    ...
                    <filter id={`fs-${product.id}`} x="-35%" y="-35%" width="170%" height="170%">
                      <feDropShadow dx="0" dy="18" stdDeviation="22" floodColor={C.hotPink} floodOpacity="0.18" />
                    </filter>
                  </defs>

                  {/* Outer dashed ring */}
                  <circle cx="250" cy="250" r="260" fill="none"
                    stroke={C.rose} strokeWidth="2" strokeDasharray="10 8" opacity="0.25" />
                  {/* Inner ring */}
                  <circle cx="250" cy="250" r="244" fill="none"
                    stroke={C.champagne} strokeWidth="1.5" opacity="0.18" />

                  {/* Drop shadow */}
                  <path d={FLOWER} fill={C.hotPink} opacity="0.06" transform="translate(6,20)"
                    filter={`url(#fs-${product.id})`} />

                  {/* Product photo, clipped to 4-petal clover */}
                  <image
                    href={activeImg}
                  ...
                  {/* Thick hot-pink clover outline */}
                  <path d={FLOWER} fill="none" stroke={C.hotPink} strokeWidth="15" strokeLinejoin="round" />
                  {/* Inner highlight */}
                  <path d={FLOWER} fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="5" strokeLinejoin="round" />
                </svg>
              </div>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            border: `3px solid ${active ? C.hotPink : "rgba(201,168,108,0.4)"}`,
                            boxShadow: active
                              ? `0 6px 0 ${C.mustardDeep}, 0 3px 16px rgba(224,61,122,0.28)`
                  ...
                  <div className="flex gap-3">
                    {thumbs.map(({ side }) => (
                      <span key={side} style={{
                        ...
                        color: activeSide === side ? C.hotPink : C.champagne,
            ...
            >
              {/* Small breadcrumb — in info column, like reference */}
              ...
              {/* ── TITLE — hot pink, magazine-scale, matches reference ── */}
              <h1 style={{
              ...
              {/* ── Price ── */}
              <div className="flex items-baseline gap-4 flex-wrap" style={{ paddingTop: 4 }}>
                <span style={{
                  fontFamily: PACIFICO,
              ...
              {/* ── CTA buttons — pill shape, 3-D, like reference ── */}
              <div className="flex flex-wrap gap-3 pt-2">
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: inStock
                      ? `0 9px 0 ${C.mustardDeep}, 0 14px 28px rgba(243,182,43,0.28), inset 0 2px 0 rgba(255,255,255,0.35)`
                      : "none",
                ...
                >
                  <Link
                    ...
                    style={{
                      ...
                      boxShadow: `0 9px 0 ${C.blueDark}, 0 14px 28px rgba(90,159,212,0.26), inset 0 2px 0 rgba(255,255,255,0.25)`,
                      textDecoration: "none",
                      transition: "box-shadow 0.15s",
                    }}
                  >
      ...
      {/* ══ Info strip — dark teal, like the blue section in reference ══ */}
      <section

...
export function Footer({}: { dictionary?: any }) {
  ...
  return (
    <footer style={{ background: "#3f6f56", color: "#fef0d6" }}>
      {/* Top stripe */}
      <div className="h-2" style={{ background: STRIPE }} aria-hidden="true" />

      <div className="container py-14 flex flex-col items-center gap-8">
        ...
        {/* Tagline */}
        <p
          className="text-[15px] text-center max-w-xs leading-relaxed"
          style={{ color: "rgba(254,240,214,0.8)", fontFamily: FRAUNCES, fontStyle: "italic" }}
        >
          {copy.footer.tagline}
        </p>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            style={{ border: "2px solid rgba(254,240,214,0.4)", color: "#fef0d6" }}
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "rgba(254,240,214,0.15)"; (e.currentTarget as HTMLElement).style.borderColor = "#fef0d6"; }}
        ...
        {/* Bottom bar */}
        <div
          className="w-full pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px]"
          style={{ borderTop: "1px solid rgba(254,240,214,0.2)", color: "rgba(254,240,214,0.55)", fontFamily: FRAUNCES }}
        >
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center">
            {legalLinks.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="hover:text-[#fef0d6] transition-colors"

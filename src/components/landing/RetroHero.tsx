  ...
  return (
    ...
    >
      ...
      <motion.header
        ...
        className="relative z-30 w-full flex items-center justify-between px-5 md:px-10 pt-5 md:pt-7"
      >
        {/* TISSU wordmark */}
        <Link href={`/${lang}`} aria-label={brand} className="shrink-0">
          <svg
        ...
        {/* Right-side icons: language + account + cart */}
